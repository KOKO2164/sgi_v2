...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [CommonModule, RouterOutlet, NavbarComponent, SideNavComponent, InicioComponent, ListarUsuarioComponent, ListarMotivoComponent, ListarEntradaMaterialComponent, ListarSalidaMaterialComponent, ListarAlmacenComponent],
